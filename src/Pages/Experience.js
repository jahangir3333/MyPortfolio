      ...
      <div class='container-fluid px-0 py-4 bg-secondary-subtle'>
        ...
        <div class="experiences d-flex flex-wrap justify-content-center gap-4">
          <div class="card shadow" style={{ width: '18rem' }}>
            <img class="card-img-top" src='https://assets.wizklub.com/images/wizklub/pages/wizklub-futurz/wiz-futurz-logo.png' alt="Card image cap" height="200px" />
            <div class="card-body">
          ...
          <div class="card shadow" style={{ width: '18rem' }}>
            <img class="card-img-top" src='https://nirmaan.org/assets/img/nirmaan-logo.png' alt="Card image cap" height="200px" />
            <div class="card-body">
              <h5 class="card-title">Coding Trainer</h5>
          ...
          <div class="card shadow" style={{ width: '18rem' }}>
            <img class="card-img-top" src='https://s3-eu-west-1.amazonaws.com/tpd/logos/6217e392835bd2246efef6e0/0x0.png' alt="Card image cap" height="200px" />
            <div class="card-body">
